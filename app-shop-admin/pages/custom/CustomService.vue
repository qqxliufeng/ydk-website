<template>
    <view>
		...
		<view class="feed-back" @click="feedBack">
			<image src="../../static/icon_feed_back.png" class="feed-back-icon"></image>
			<text class="feed-back-tip">意见反馈</text>
		</view>
    </view>
</template>
  ...
  methods: {
	...
	feedBack () {
		if (this.$userInfo.isLogin()) {
			this.$push('/pages/feedback/FeedBack')
		} else {
			this.$mRouter.login('/pages/feedback/FeedBack')
		}
	}
  },
  onLoad () {
